  ...
  head: () => ({
    meta: [
      { title: "Join Letterbox — Kids Money Adventure" },
      {
        name: "description",
        content:
          "Create a Letterbox account, pick a buddy avatar and start the money adventure for ages 5-7.",
      },
      { property: "og:title", content: "Join Letterbox — Kids Money Adventure" },
      {
        property: "og:description",
        content: "Sign up in seconds and start collecting coins with Boxy.",
      },
    ],
  }),
  component: Signup,
  ...
  return (
    <Screen withNav={false}>
      ...
      <p className="mt-1 text-sm font-semibold text-muted-foreground">
        A grown-up can help with this bit.
      </p>
      ...
      <section className="mt-6">
        ...
        <div className="mt-2 grid grid-cols-6 gap-2">
          {avatars.map((a, i) => (
            <button
              key={a}
              className={`grid aspect-square place-items-center rounded-2xl border-2 text-2xl shadow-card active:scale-95 ${
